...
awful.keyboard.append_global_keybindings({
        ...
        {description = "open burp proxy", group = "launcher"})
})
...
awful.keyboard.append_global_keybindings({
    ...
    -- Brightness Control
    awful.key({alt}, "XF86MonBrightnessUp", function() 
        awful.spawn("brightnessctl set 5%+ -q") 
    end,
    {description = "increase brightness", group = "hotkeys"}),
    awful.key({alt}, "XF86MonBrightnessDown", function() 
        awful.spawn("brightnessctl set 5%- -q") 
    end,
    {description = "decrease brightness", group = "hotkeys"}),

    -- Volume control
    awful.key({alt}, "XF86AudioRaiseVolume", function()
        helpers.volume_control(5)
    end,
    {description = "increase volume", group = "hotkeys"}),
    awful.key({alt}, "XF86AudioLowerVolume", function()
        helpers.volume_control(-5)
    end,
    {description = "decrease volume", group = "hotkeys"}),
    awful.key({alt}, "XF86AudioMute", function()
        helpers.volume_control(0)
    end,
    {description = "mute volume", group = "hotkeys"}),

    -- Music
    awful.key({alt}, "XF86AudioPlay", function()
        playerctl:play_pause()
    end,
    {description = "toggle music", group = "hotkeys"}),

    awful.key({alt}, "XF86AudioPrev", function()
        playerctl:previous()
    end,
    {description = "previous music", group = "hotkeys"}),

    awful.key({alt}, "XF86AudioNext", function()
        playerctl:next()
    end,
    ...
    awful.key({alt, "Shift"}, "Print", function()
...
client.connect_signal("request::default_keybindings", function()
    awful.keyboard.append_client_keybindings({
        ...
        awful.key({modkey, alt}, "q", function(c) 
            c:kill() 
        end,
